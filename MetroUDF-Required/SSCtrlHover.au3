...
Local Const $_cHvr_PINTERNALSUBCLASS_DLL = DllCallbackRegister('_cHvr_iProc', 'NONE', 'HWND;UINT;WPARAM;LPARAM;DWORD'); < _cHvr_iProc()
Local Const $_cHvr_PINTERNALSUBCLASS = DllCallbackGetPtr($_cHvr_PINTERNALSUBCLASS_DLL)

OnAutoItExitRegister("_cHvr_Finalize")
If @AutoItX64 Then
$_cHvr_TSUBCLASSEXE = Call('_cHvr_CSCP_X64'); <=> _cHvr_CSCP_X64()
Else
$_cHvr_TSUBCLASSEXE = Call('_cHvr_CSCP_X86'); <=> _cHvr_CSCP_X86()
EndIf
...
If @AutoItX64 Then
$_cHvr_PSUBCLASSEXE = _cHvr_ExecutableFromStruct(Call('_cHvr_CSCP_X64')); <=> _cHvr_CSCP_X64()
Else
$_cHvr_PSUBCLASSEXE = _cHvr_ExecutableFromStruct(Call('_cHvr_CSCP_X86')); <=> _cHvr_CSCP_X64()
EndIf
...
;	MsgBox(0,$iCallType,$aCtrlData[$iCallType]&@CRLF&$aCtrlData[1]&@CRLF&$aCtrlData[$iCallType + 1])
